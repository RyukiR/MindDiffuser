...
def main():
    ...
    for i in tqdm(range(982)):
        y_pred = decode_LDM_text_feature(args.val_file_ex, 450, args.text_mean_path, args.text_std_path, args.cls_token_path, args.model_save_path , args.recons_img_idx)
